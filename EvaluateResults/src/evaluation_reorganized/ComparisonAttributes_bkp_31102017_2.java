...
public class ComparisonAttributes_bkp_31102017_2 {
	...
	protected static void loadAllData(String respectiveHumphreyKey, String patient) {
		...
		setUpDevicesFields(leftReportPrototypeData, rightReportPrototypeData, leftReportHumphreyData, rightReportHumphreyData);
	}
	...
	protected static void setUpDevicesFields(List<LoaderVisualField> leftReportPrototypeData,
		...
		field_left_prototype_1 = leftReportPrototypeData.size() > 1 && leftReportHumphreyData.size() > 1 ? 
				leftReportPrototypeData.get(0).getParameters().getIntensitiesAsDouble() : null;
		field_left_prototype_2 = leftReportPrototypeData.size() > 1 && leftReportHumphreyData.size() > 1 ? 
				leftReportPrototypeData.get(1).getParameters().getIntensitiesAsDouble() : null;
		field_left_humphrey_1 = leftReportPrototypeData.size() > 1 && leftReportHumphreyData.size() > 1? 
				leftReportHumphreyData.get(0).getNumericIntensities() : null;
		field_left_humphrey_2 = leftReportPrototypeData.size() > 1 && leftReportHumphreyData.size() > 1 ? 
