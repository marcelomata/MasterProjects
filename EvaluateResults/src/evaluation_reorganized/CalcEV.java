...
public class CalcEV extends ComparisonAttributes {
...
//		System.out.print(patient+",\n");
		...
		if(!checkFieldsNull()) {
			...
			ev_left_prototype = Math.sqrt(StatisticsComparation.EV(field1_left_1, field1_left_2, variancePrototype2, true));
			ev_right_prototype = Math.sqrt(StatisticsComparation.EV(field1_right_1, field1_right_2, variancePrototype2, false));
